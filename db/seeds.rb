...
User.create!(username: "Aaron", first_name: "Aaron", last_name: "Barkhurst", journal_description:"Trying to live my best intentional life", email: "aaron@example.com", password: "password")
require "csv"
...
Joy.create!(user_id:2, body: "Abigail's giggles make my heart so happy!", visibility: true, created_at:"2021-5-01 00:00:00", updated_at: "2021-5-01 00:00:00")
Relationship.create!(inspired_id:1822, parent_id:1229)
Joy.create!(user_id:3, body: "Hearing Abigail and Abby playing and laughing!", visibility: true, created_at:"2021-5-03 00:00:00", updated_at: "2021-5-03 00:00:00")
Relationship.create!(inspired_id:1823, parent_id:1229)
Joy.create!(user_id:2, body: "I'm so grateful that our kids have friends that live right across the street. Abby, Rebecca and Max are such a blessing!", visibility: true, created_at:"2021-5-04 00:00:00", updated_at: "2021-5-04 00:00:00")
Relationship.create!(inspired_id:1824, parent_id:1823)
Joy.create!(user_id:3, body: "Great neighbors! Such a good Covid Pod", visibility: true, created_at:"2021-5-5 00:00:00", updated_at: "2021-5-5 00:00:00")
Relationship.create!(inspired_id:1825, parent_id:1824)
Joy.create!(user_id:3, body: "Our epic Covid outdoor Halloween Bash. Spiked Apple Cider; Hocus Pocus; Floating lanterns; wind storm!", visibility: true, created_at:"2021-5-6 00:00:00", updated_at: "2021-5-6 00:00:00")
Relationship.create!(inspired_id:1826, parent_id:1825)
Joy.create!(user_id:3, body: "Nothing beats a London Fog. Yum!", visibility: true, created_at:"2021-4-6 00:00:00", updated_at: "2021-4-6 00:00:00")
Relationship.create!(inspired_id:1827, parent_id:1229)
Joy.create!(user_id:2, body: "Yoga on the beach.", visibility: true, created_at:"2012-4-24 00:00:00", updated_at: "2012-4-24 00:00:00")
Relationship.create!(inspired_id:1828, parent_id:1483)
Joy.create!(user_id:2, body: "Amanda (my Actualize instructor) loves pineapple!", visibility: true, created_at:"2021-5-6 00:00:00", updated_at: "2021-5-6 00:00:00")
Relationship.create!(inspired_id:1829, parent_id:1486)
Joy.create!(user_id:2, body: "Seriously, six-year old Abby's laugh is contagious. I love hearing her play while she's over at our house", visibility: true, created_at:"2021-5-1 00:00:00", updated_at: "2021-5-1 00:00:00")
Relationship.create!(inspired_id:1830, parent_id:1825)